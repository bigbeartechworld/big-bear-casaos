...
The v2 store output (`dist/`) is generated by `IceWhaleTech/build-appstore-action` and published to the `gh-pages` branch on every merge to `master`. Do NOT hand-edit generated output.

v2 subscription URL: `https://cdn.jsdelivr.net/gh/bigbeartechworld/big-bear-casaos@gh-pages/store.json`

Legacy v1 clients continue to use GitHub's repository archive: `https://github.com/bigbeartechworld/big-bear-casaos/archive/refs/heads/master.zip` (served automatically from the `Apps/` tree, no build step).
